...
db_app <- db_connect("rav_utrecht", preset = "postgres_application_admin")
db_app_new <- db_connect("rav_utrecht", preset = "postgres_application_new_admin")

table_names <- c(
  "resource",
  "ritten_raw",
  "ritten_uit_koppeling",
  "sb_ambulance_task",
  "scenario"
)
